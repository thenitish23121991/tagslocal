...
if(data != null){
if(data.length == 0){	
var promise = products.insert({'name':name,'description':description,'pic_path':pic_path,'category':category,'brand':brand,'price':price,'specification_array':JSON.stringify(specs_arr),'specs_html':specs_html,'url':name,'views':0});
