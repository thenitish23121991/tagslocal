...
var retailer_colors = require('retailer_colors');
...
var promise = products.find({name:new RegExp(term,'i'),brand:new RegExp('^'+term,'i')},{limit:14});
promise.on('complete',function(err,docs){
...
get_product_colors : function(retailer,product,callback){
